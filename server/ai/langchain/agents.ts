...
const routerAgent: ChatOpenAI = new ChatOpenAI({
  modelName: ROUTER_MODEL,
  temperature: 0.2,
  maxTokens: 512
});

const sceneryAgent: ChatOpenAI = new ChatOpenAI({
