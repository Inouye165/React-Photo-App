...
const DEFAULT_WS_MAX_PAYLOAD_BYTES = process.env.NODE_ENV === 'development' ? 64 * 1024 * 1024 : 16 * 1024 * 1024;
const MAX_WS_PAYLOAD_BYTES = Number.parseInt(process.env.WS_MAX_PAYLOAD_BYTES || '', 10) || DEFAULT_WS_MAX_PAYLOAD_BYTES;
