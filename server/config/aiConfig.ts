 ...
 * @constant
 * @type {Object}
 * @property {number} HIGH - High confidence (â‰¥0.9). Results shown as definitive.
 * @property {number} REVIEW - Review threshold (â‰¥0.8). Below this, UI shows "Check this" indicator.
 * @property {number} LOW - Low confidence (â‰¥0.5). Below this, value is shown as "Suggestion" only.
 */
