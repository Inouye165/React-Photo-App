/**
 * Diagnostic script to test API keys
 * 
 * Tests Google Maps API and OpenAI API to identify configuration issues.
 * Shows specific error messages from APIs to help debug authentication problems.
 */
