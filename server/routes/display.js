...
module.exports = function createDisplayRouter({ db }) {
  ...
  function authenticateThumbnail(req, res, next) {
    ...
    // 
    // CodeQL Justification: While sig and exp are user-controlled query parameters,
    // they do not directly control the authentication bypass. The bypass only occurs
