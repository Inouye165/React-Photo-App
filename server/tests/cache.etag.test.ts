...
const PREV_MEDIA_REDIRECT_ENABLED: string | undefined = process.env.MEDIA_REDIRECT_ENABLED;
...
describe('ETag/304 cache', () => {
  let authToken: string = 'valid-token';
  ...
  it('should set ETag and respond 304 to If-None-Match', async () => {
    const filename: string = 'test_cache_photo.jpg';
    const state: string = 'inprogress';
