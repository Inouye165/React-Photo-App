...
describe('Protected Routes - Bearer Token Authentication', () => {
  ...
  beforeEach(() => {
    ...
    app.get('/photos', authenticateToken, (req: any, res: any) => {
      res.json({
        success: true,
        photos: [],
        userId: req.user.id
    ...
    app.get('/photos/:id', authenticateToken, (req: any, res: any) => {
      res.json({
        success: true,
  ...
  describe('Cross-Origin Requests with Bearer Token', () => {
    let corsApp: ReturnType<typeof express>;
    ...
    beforeEach(() => {
      ...
      corsApp.get('/api/users/me', authenticateToken, (req: any, res: any) => {
...
describe('Image Endpoint Authentication', () => {
  ...
  beforeEach(() => {
    ...
    const mockOrigins: string[] = ['http://localhost:5173'];
    jest.mock('../config/allowedOrigins', () => ({
      getAllowedOrigins: () => mockOrigins,
      resolveAllowedOrigin: (origin: string | null) => {
    ...
    app.get('/display/image/:id', authenticateImageRequest, (req: any, res: any) => {
      res.json({
        success: true,
