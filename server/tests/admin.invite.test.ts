  ...
  const mockFn: jest.Mock = jest.fn((tableName: string) => {
    if (tableName === 'photos') {
      const createChain = () => {
        const chain = {
          ...
          whereNotNull: jest.fn(function(this: any) { return this; }),
    ...
    if (tableName === 'comments' || tableName === 'comments as c') {
      const createChain = () => {
        const chain = {
          where: jest.fn(function(this: any) { return this; }),
          whereIn: jest.fn(function(this: any) { return this; }),
          orderBy: jest.fn(function(this: any) { return this; }),
          limit: jest.fn(function(this: any) { return this; }),
          offset: jest.fn(function(this: any) { return this; }),
...
describe('Admin Routes', () => {
  ...
  const csrfToken: string = 'test-csrf-token';
  const testOrigin: string = 'https://good.com';
  ...
  describe('GET /api/admin/comments', () => {
    ...
    it('should still return comments when related user or photo lookups fail', async () => {
      ...
      const resilientDb: jest.Mock = jest.fn((tableName: string) => {
        if (tableName === 'comments as c') {
          const chain = {
            ...
            limit: jest.fn(function(this: any) { return this; }),
            offset: jest.fn(function(this: any) { return this; }),
            then: jest.fn((resolve: Function) => resolve(commentsRows))
          };
          return chain;
        }
      ...
      (resilientDb as any).fn = { now: jest.fn(() => 'NOW()') };
